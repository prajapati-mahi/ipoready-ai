...
os.makedirs(os.path.join(fe_root, "app", "metrics"), exist_ok=True)
with open(os.path.join(fe_root, "app", "metrics", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(metrics_code.strip() + "\n")
print("Financial Metrics page created.")
