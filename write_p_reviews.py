...
os.makedirs(os.path.join(fe_root, "app", "reviews"), exist_ok=True)
with open(os.path.join(fe_root, "app", "reviews", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(reviews_code.strip() + "\n")
print("Review Queue page created.")
