...
os.makedirs(os.path.join(fe_root, "app", "evaluation"), exist_ok=True)
with open(os.path.join(fe_root, "app", "evaluation", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(eval_code.strip() + "\n")
print("AI Evaluation page created.")
