# IPOReady AI — Intelligent IPO Readiness & Financial Document Analysis Platform
...
- Compares values across documents:
  $$	ext{Variance \%} = rac{|	ext{Value}_A - 	ext{Value}_B|}{\min(	ext{Value}_A, 	ext{Value}_B)} 	imes 100$$
