...
os.makedirs(os.path.join(fe_root, "app", "readiness"), exist_ok=True)
with open(os.path.join(fe_root, "app", "readiness", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(readiness_code.strip() + "\n")
print("IPO Readiness page created.")
